              ...
              >
                <mat-form-field appearance="outline">
                  ...
                  <mat-select [formControlName]="'category_' + category.id">
                    ...
                    <mat-option 
                      *ngFor="let option of getOptionsForCategory(category.id); trackBy: trackByOption"
                      [value]="option.value"
                    >
                      {{ option.description }}
                    </mat-option>
...
export class ParticleSubtypeCardComponent implements OnInit {
  ...
  hasValues = computed(() => {
    ...
    return Object.values(this.subtypeForm.value).some(value => value !== null && value !== undefined);
  });
